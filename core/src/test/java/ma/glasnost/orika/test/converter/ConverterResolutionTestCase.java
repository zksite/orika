...
/**
 * This test case is intended to assert the resolution behavior for converters
 * with respect to the order in which they are registered, and their relation to
 * the source/destination types (w/respect to class hierarchy).
 * 
...
public class ConverterResolutionTestCase {
    ...
    public void testResolveSingleConverter() {
        ...
        Converter<?, ?> converter = factory.getConverterFactory().getConverter(TypeFactory.valueOf(Name.class),
    ...
    public void testResolveMultipleConverters() {
        ...
        Converter<?, ?> converter = converterFactory.getConverter(TypeFactory.valueOf(ExtendedName.class),
                TypeFactory.valueOf(String.class));
    ...
    public static class NameToStringConverter extends CustomConverter<Name, String> {
         ...
         */
        public String convert(Name source, Type<? extends String> destinationType, MappingContext context) {
    ...
    public static class ExtendedNameToStringConverter extends CustomConverter<ExtendedName, String> {
         ...
         * ma.glasnost.orika.metadata.Type)
         */
        public String convert(ExtendedName source, Type<? extends String> destinationType, MappingContext context) {
